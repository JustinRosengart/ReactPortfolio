                ...
                <div className={`${themeClasses.card.base} p-8`}>
                    ...
                    <div className="text-center mb-12">
                        <div
                            ...
                            <div
                                className={`${themeClasses.bg.primaryLighter} rounded-xl shadow-sm flex items-center justify-center transition-colors duration-200`}>
                                <img src={`${personalInfo.image}`}
                                     alt={`${personalInfo.name}`}
                                     className="w-58 h-58 object-cover border-4 shadow-md rounded-2xl"/>
                            </div>
                        </div>
                        <h1 className={`text-3xl font-bold ${themeClasses.text.primaryDark} mb-2`}>{personalInfo.name}</h1>
                        <p className={`${themeClasses.text.primaryLight} mb-2`}>{personalInfo.titleLong}</p>
                        <p className={`${themeClasses.text.primary}`}>{personalInfo.location.city + ", " + personalInfo.location.region + ", " + personalInfo.location.country}</p>
                    </div>

                    {/* About */}
                    <div className="mb-12">
                        <p className={`${themeClasses.text.primaryLight} leading-relaxed text-center max-w-3xl mx-auto`}>
                    ...
                    <div className="mb-12">
                        ...
                        <div className="flex flex-wrap justify-center gap-3">
                            {personalInfo.topSkills.map((skill) => (
                                <span key={skill}
                                      className={`px-4 py-2 ${themeClasses.bg.primaryLight} ${themeClasses.text.primaryDark} rounded-full text-sm transition-colors duration-200`}>
                                    {skill}
                                </span>
                            ))}
                        </div>
                    ...
                    {experiences.length > 0 && (
                        <div className="mb-12">
                            <h2 className={`text-2xl font-bold ${themeClasses.text.primaryDark} text-center mb-8`}>Experience</h2>
                                    ...
                                    return (
                                        <div key={experience.id} className="flex items-start space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className={`font-semibold ${themeClasses.text.primaryDark}`}>{experience.title}</p>
                                                <p className={`${themeClasses.text.primary} text-sm mb-2`}>
                                                    {experience.startDate} - {experience.endDate || 'Present'}
                                                    {experience.duration && ` · ${experience.duration}`}
                                                </p>
                                                {experience.location && (
                                                    <p className={`${themeClasses.text.primaryLight} text-sm`}>
                                                        {experience.location}{experience.type && ` · ${experience.type}`}
                                                    </p>
                                                )}
                                                {experience.description && (
                                                    <p className={`${themeClasses.text.primaryLight} text-sm mt-2`}>{experience.description}</p>
                                                )}
                                                {experience.skills.length > 0 && (
                                                    <div className="mt-2">
                                                        {experience.skills.map((skill, index) => (
                                                            <span key={skill}
                                                                  className={`inline-flex items-center px-2 py-1 text-xs ${themeClasses.bg.primaryLight} ${themeClasses.text.primaryDark} rounded ${index > 0 ? 'ml-2' : ''}`}>
                                                            {skill}
                                                        </span>
                                                        ))}
                                                    </div>
                    ...
                    {educations.length > 0 && (
                        <div className="mb-12">
                            <h2 className={`text-2xl font-bold ${themeClasses.text.primaryDark} text-center mb-8`}>Education</h2>
                            <div className="space-y-8">
                                    ...
                                    return (
                                        <div key={education.id} className="flex items-start space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className={`${themeClasses.text.primaryLight}`}>
                                                ...
                                                {education.grade && (
                                                    <p className={`${themeClasses.text.primary} text-sm`}>Grade: {education.grade}</p>
                                                )}
                                                {education.description && (
                                                    <p className={`${themeClasses.text.primaryLight} text-sm mt-2`}>{education.description}</p>
                                                )}
                    ...
                    {certifications.length > 0 && (
                        <div className="mb-12">
                            <h2 className={`text-2xl font-bold ${themeClasses.text.primaryDark} text-center mb-8`}>Certifications</h2>
                                ...
                                {certifications.map((certification) => {
                                    ...
                                    return (
                                        <div key={certification.id} className="flex items-start space-x-4">
                                            ...
                                            <div>
                                                <h3 className={`font-semibold ${themeClasses.text.primaryDark}`}>{certification.credentialUrl ? (
                                                ...
                                                {certification.description && (
                                                    <p className={`${themeClasses.text.primaryLight} text-sm mt-2`}>{certification.description}</p>
                                                )}
                                            </div>
                                        </div>
                                    );
